 ...
 *
 * Disassembly of DSDT.aml, Thu Jan 31 23:19:29 2019
 *
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "TP-JB   ", 0x00001350)
{
    ...
    External (_SB_.PCI0.LPCB.TPM_._STA, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.TPM_.BUF1, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.TPM_.CMOR, MethodObj)    // 0 Arguments (from opcode)
    ...
    Scope (_SB)
    {
        Method (_INI, 0, NotSerialized)  // _INI: Initialize
        {
            ...
            Store (One, OSIF)
            Store (^PCI0.LPCB.EC.AC._PSR (), PWRS)
            ^PCI0.LPCB.MOU.MHID ()
            If (LNUX)
            {
            ...
            Store (SRE1, ^PCI0.RP01.RID)
            Store (SRE2, ^PCI0.RP02.RID)
            Store (SRE3, ^PCI0.RP03.RID)
        ...
        Device (LNKA)
        {
            ...
            {
                Or (^^PCI0.LPCB.PIRA, 0x80, ^^PCI0.LPCB.PIRA)
            }
            ...
            {
                And (^^PCI0.LPCB.PIRA, 0x8F, Local0)
                If (VPIR (Local0))
                {
            ...
            Method (_SRS, 1, NotSerialized)  // _SRS: Set Resource Settings
            {
                ...
                And (^^PCI0.LPCB.PIRA, 0x70, Local1)
                Or (Local1, Decrement (Local0), Local1)
                Store (Local1, ^^PCI0.LPCB.PIRA)
            }
        }
        ...
        Device (LNKB)
        {
            ...
            Method (_DIS, 0, NotSerialized)  // _DIS: Disable Device
            {
                Or (^^PCI0.LPCB.PIRB, 0x80, ^^PCI0.LPCB.PIRB)
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                And (^^PCI0.LPCB.PIRB, 0x8F, Local0)
                If (VPIR (Local0))
                {
            ...
            Method (_SRS, 1, NotSerialized)  // _SRS: Set Resource Settings
            {
                ...
                And (^^PCI0.LPCB.PIRB, 0x70, Local1)
                Or (Local1, Decrement (Local0), Local1)
                Store (Local1, ^^PCI0.LPCB.PIRB)
            }
        }
        ...
        Device (LNKC)
        {
            ...
            Method (_DIS, 0, NotSerialized)  // _DIS: Disable Device
            {
                Or (^^PCI0.LPCB.PIRC, 0x80, ^^PCI0.LPCB.PIRC)
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                And (^^PCI0.LPCB.PIRC, 0x8F, Local0)
                If (VPIR (Local0))
                {
            ...
            Method (_SRS, 1, NotSerialized)  // _SRS: Set Resource Settings
            {
                ...
                And (^^PCI0.LPCB.PIRC, 0x70, Local1)
                Or (Local1, Decrement (Local0), Local1)
                Store (Local1, ^^PCI0.LPCB.PIRC)
            }
        }
        ...
        Device (LNKD)
        {
            ...
            Method (_DIS, 0, NotSerialized)  // _DIS: Disable Device
            {
                Or (^^PCI0.LPCB.PIRD, 0x80, ^^PCI0.LPCB.PIRD)
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                And (^^PCI0.LPCB.PIRD, 0x8F, Local0)
                If (VPIR (Local0))
                {
            ...
            Method (_SRS, 1, NotSerialized)  // _SRS: Set Resource Settings
            {
                ...
                And (^^PCI0.LPCB.PIRD, 0x70, Local1)
                Or (Local1, Decrement (Local0), Local1)
                Store (Local1, ^^PCI0.LPCB.PIRD)
            }
        }
        ...
        Device (LNKE)
        {
            ...
            Method (_DIS, 0, NotSerialized)  // _DIS: Disable Device
            {
                Or (^^PCI0.LPCB.PIRE, 0x80, ^^PCI0.LPCB.PIRE)
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                And (^^PCI0.LPCB.PIRE, 0x8F, Local0)
                If (VPIR (Local0))
                {
            ...
            Method (_SRS, 1, NotSerialized)  // _SRS: Set Resource Settings
            {
                ...
                And (^^PCI0.LPCB.PIRE, 0x70, Local1)
                Or (Local1, Decrement (Local0), Local1)
                Store (Local1, ^^PCI0.LPCB.PIRE)
            }
        }
        ...
        Device (LNKF)
        {
            ...
            Method (_DIS, 0, NotSerialized)  // _DIS: Disable Device
            {
                Or (^^PCI0.LPCB.PIRF, 0x80, ^^PCI0.LPCB.PIRF)
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                And (^^PCI0.LPCB.PIRF, 0x8F, Local0)
                If (VPIR (Local0))
                {
            ...
            Method (_SRS, 1, NotSerialized)  // _SRS: Set Resource Settings
            {
                ...
                And (^^PCI0.LPCB.PIRF, 0x70, Local1)
                Or (Local1, Decrement (Local0), Local1)
                Store (Local1, ^^PCI0.LPCB.PIRF)
            }
        }
        ...
        Device (LNKG)
        {
            ...
            Method (_DIS, 0, NotSerialized)  // _DIS: Disable Device
            {
                Or (^^PCI0.LPCB.PIRG, 0x80, ^^PCI0.LPCB.PIRG)
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                And (^^PCI0.LPCB.PIRG, 0x8F, Local0)
                If (VPIR (Local0))
                {
            ...
            Method (_SRS, 1, NotSerialized)  // _SRS: Set Resource Settings
            {
                ...
                And (^^PCI0.LPCB.PIRG, 0x70, Local1)
                Or (Local1, Decrement (Local0), Local1)
                Store (Local1, ^^PCI0.LPCB.PIRG)
            }
        }
        ...
        Device (LNKH)
        {
            ...
            Method (_DIS, 0, NotSerialized)  // _DIS: Disable Device
            {
                Or (^^PCI0.LPCB.PIRH, 0x80, ^^PCI0.LPCB.PIRH)
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                And (^^PCI0.LPCB.PIRH, 0x8F, Local0)
                If (VPIR (Local0))
                {
            ...
            Method (_SRS, 1, NotSerialized)  // _SRS: Set Resource Settings
            {
                ...
                And (^^PCI0.LPCB.PIRH, 0x70, Local1)
                Or (Local1, Decrement (Local0), Local1)
                Store (Local1, ^^PCI0.LPCB.PIRH)
            }
        }
        ...
        Device (MEM)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                If (LNot (CondRefOf (\_SB.PCI0.LPCB.TPM)))
                {
                    Store (0x01400000, MEL2)
                    Store (Zero, MEL3)
                }
                ElseIf (LNotEqual (^^PCI0.LPCB.TPM._STA, 0x0F))
                {
                    Store (0x01400000, MEL2)
                    Store (Zero, MEL3)
                }
                ...
                If (LEqual (Arg0, ToUUID ("33db4d5b-1ff7-401c-9657-7441c03dd766") /* PCI Host Bridge Device */))
                {
                    ...
                    If (LNot (And (CDW1, One)))
                    {
                        If (And (CTRL, One))
                        {
                            If (LNot (VIGD))
                            {
                                Store (Zero, ^PEG0.HPGP)
                                Store (Zero, ^PEG0.GMGP)
                            }
                    ...
                    Name (BUF0, ResourceTemplate()
{
                    ...
                    Method (NBCI, 4, Serialized)
                    {
                        ...
                        While (One)
                        {
                            ...
                            ElseIf (LEqual (T_0, 0x14))
                            {
                                ...
                                {
                                    Store (DerefOf (Index (DerefOf (Index (^^^LPCB.EC.BRTD, BRTN)), Local1)), Local2)
            ...
            Method (NVPS, 4, Serialized)
            {
                ...
                While (One)
                {
                    ...
                    ElseIf (LEqual (T_0, 0x2A))
                    {
                        ...
                        While (One)
                        {
                            Store (ToInteger (QTYP), T_1)
                            If (LEqual (T_1, Zero))
                            {
                                Store (^^^LPCB.EC.TMP0, Local1)
                            ...
                            ElseIf (LEqual (T_1, 0x02))
                            {
                                Store (0x50, Local1)
                                Store (Zero, Local2)
                                Store (Local1, ^^^LPCB.EC.HIID)
                                Store (^^^LPCB.EC.GP50, Local3)
                                Store (Local2, ^^^LPCB.EC.HIID)
    ...
    Method (_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        If (Local0)
        {
            ...
            If (LEqual (Arg0, 0x03))
            {
                If (LEqual (\_SB.PCI0.LPCB.EC.DGCS, One))
                {
                    Notify (\_SB.PCI0.PEG0.IGPU, 0xD1)
                    Store (Zero, \_SB.PCI0.LPCB.EC.DGCS)
                }
                ...
                If (And (Local1, 0x20))
                {
                    ...
                    {
                        If (LOr (LAnd (\_SB.PCI0.LPCB.EC.HB0A, LGreater (And (\_SB.PCI0.LPCB.EC.HB0S, 0x07), One)), LAnd (\_SB.PCI0.LPCB.EC.HB1A, LGreater (And (\_SB.PCI0.LPCB.EC.HB1S, 0x07), One))))
                        {
                            Store (Zero, FFCL)
                        }
                        Else
    ...
    Scope (_GPE)
    {
        ...
        {
            If (LAnd (GPFG, \_SB.PCI0.LPCB.NFCI))
            {
                Store (Zero, GPFG)
                Notify (\_SB.PCI0.SBUS.NFC, 0xC0)
            }
        }
    }
